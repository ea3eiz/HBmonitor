REPORT_NAME     = 'HBlink de EAXXXX'  # Name of the monitored HBlink system
CONFIG_INC      = True                  # Include HBlink stats
BRIDGES_INC     = True                  # Include Bridge stats (confbrige.py)
HBLINK_IP      = '127.0.0.1'           # HBlink's IP Address
HBLINK_PORT    = 4321                  # HBlink's TCP reporting socket
FREQUENCY       = 10                    # Frequency to push updates to web clients
WEB_SERVER_PORT = 7878                  # Has to be above 1024 if you're not running as root
...
PEER_URL        = 'https://www.radioid.net/api/dmr/repeater/?country='
SUBSCRIBER_URL  = 'https://www.radioid.net/api/dmr/user/?country='
