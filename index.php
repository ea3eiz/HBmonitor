...
<meta http-equiv="refresh" content="4; url=/var/www/html/index.php" />
<!-- refresca la página cada 10 segundo (implantado por mi) -->
<!-- ====================================================== -->
<!-- <meta http-equiv="refresh" content="5" /> -->

    <link rel="shortcut icon" href="img/Logo_Allstar.png">
    <title>Inicio</title>
    <!-- CSS Bootstrap-->
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    ...
                    <a href="https://web-tpa.allstarlink.org/nodelist/" class="img-responsive"><img src="img/Logo_Allstar.png" width="100" alt=""></a>
            </div>
...
<div class="row">
            ...
            <div class="col-md-4">
                <div class="caja_login panel-default">
                    ...
                    <p><img src="img/Logo_Allstar.png" height="40"></p>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-text">
                        <span class="name">ALLSTAR Todos los Sistemas</span>
                        <hr class="star-light header"><br>
                        <span class="name">NODO - <?php echo $nodo ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<p class="ir-arriba pull-right"><a href="#"><span class="glyphicon glyphicon-arrow-up"></span></a></p>
        <p class="color_naranja_izquierd">&copy; Allstar ADER 2019&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Design by:&nbsp;&nbsp;( EA3EIZ )</p>
      </footer>
<!-- FIN  DEL FOOTER ==================================== -->
    </header>
    <!-- jQuery -->
